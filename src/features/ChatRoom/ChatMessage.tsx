...
const userTextClass = "mr-2 py-3 px-4 ml-10 bg-blue-400 rounded-bl-3xl rounded-tl-3xl rounded-tr-xl text-white"
const robotTextClass = "ml-2 py-3 px-4 mr-10 bg-gray-400 rounded-br-3xl rounded-tr-3xl rounded-tl-xl text-white"
